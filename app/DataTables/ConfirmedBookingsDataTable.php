...
use App\Models\CompletedBooking;
...
class ConfirmedBookingsDataTable extends DataTable
{
    /**
    ...
    {
        return $model->where('booking_status','confirmed');
    }
    ...
    {
        return $this->builder()
                    ->setTableId('completedbookings-table')
    ...
    {
        return 'CompletedBookings_' . date('YmdHis');
    }
}
