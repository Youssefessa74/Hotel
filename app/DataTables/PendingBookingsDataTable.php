...
class PendingBookingsDataTable extends DataTable
{
    /**
    ...
    {
        return $model->where('booking_status','pending');
    }
    ...
    {
        return $this->builder()
                    ->setTableId('pendingbookings-table')
    ...
    {
        return 'PendingBookings_' . date('YmdHis');
    }
}
