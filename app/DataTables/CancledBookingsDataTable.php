...
class CancledBookingsDataTable extends DataTable
{
    /**
    ...
    {
        return $model->where('booking_status','canceled');
    }
    ...
    {
        return $this->builder()
                    ->setTableId('cancledbookings-table')
    ...
    {
        return 'CancledBookings_' . date('YmdHis');
    }
}
