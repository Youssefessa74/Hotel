<nav style="margin-bottom: 90px" class="navbar">
    ...
    <div class="navbar-content">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle drop_down_for_messages" href="#" id="messageDropdown"
                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i data-feather="mail"></i>
                    <div class="indicator indicator_for_messages" id="notificationIndicator" style="display: block;">
                        <div class="circle circle_messages"></div>
                    </div>
                </a>
            ...
            <li class="nav-item dropdown">
                ...
                <a class="nav-link dropdown-toggle" href="#" id="notificationDropdown" role="button"
                    ...
                    <div class="indicator" id="notificationIndicatorForMessages" style="display:;">
                        ...
                        <div class="p-1 notification_pusher">
                            <a href="" class="dropdown-item d-flex align-items-center py-2">
                                ...
                                <div class="flex-grow-1 me-2">
                                    <p>message</p>
                                    <p class="tx-12 text-muted">13:22:55 2020/5/3</p>
                                </div>
                            </a>
                        </div>
                        {{-- @endforeach --}}
